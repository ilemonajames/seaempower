...
:root {
  ...
  --bs-link-color: #3fbd9a;
  --bs-link-hover-color: #32977b;
...
.form-switch .form-check-input:focus {
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='%230fac81'/%3e%3c/svg%3e");
}
...
.form-range:focus::-webkit-slider-thumb {
  box-shadow: 0 0 0 1px #fff, 0 0 0 3px rgba(15, 172, 129, 0.1);
}
...
.btn-outline-primary {
  ...
  --bs-btn-border-color: #0fac81;
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: #0fac81;
  --bs-btn-hover-border-color: #0fac81;
  --bs-btn-focus-shadow-rgb: 15, 172, 129;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: #0fac81;
  --bs-btn-active-border-color: #0fac81;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(16, 25, 36, 0.125);
  --bs-btn-disabled-color: #0fac81;
...
.dropdown-menu {
  ...
  --bs-dropdown-box-shadow: 0 3px 12px 1px rgba(7, 82, 61, 0.15);
...
.accordion {
  ...
  --bs-accordion-btn-focus-border-color: #0fac81;
  --bs-accordion-btn-focus-box-shadow: 0 0 0 3px rgba(15, 172, 129, 0.1);
...
.pagination {
  ...
  --bs-pagination-hover-color: #32977b;
  ...
  --bs-pagination-active-bg: #0fac81;
  --bs-pagination-active-border-color: #0fac81;
...
.alert-primary {
  --bs-alert-color: #0b785a;
  --bs-alert-bg: #e2f5f0;
  --bs-alert-border-color: #b7e6d9;
}
...
.text-bg-primary {
  color: #fff !important;
  background-color: RGBA(15, 172, 129, var(--bs-bg-opacity, 1)) !important;
}
...
.swal2-popup.swal2-toast .swal2-styled:focus {
  box-shadow: 0 0 0 1px #fff, 0 0 0 3px rgba(15, 172, 129, 0.4);
}
...
@-moz-document url-prefix() {
  .swal2-close:focus {
    outline: 2px solid rgba(15, 172, 129, 0.4);
  }
}
...
.fc-h-event { /* allowed to be top-level */
  display: block;
  border: 1px solid #0fac81;
  border: 1px solid var(--fc-event-border-color, #0fac81);
  background-color: #0fac81;
  background-color: var(--fc-event-bg-color, #0fac81);
}
...
.fc .fc-daygrid-day.fc-day-today {
  background-color: rgba(15, 172, 129, 0.07);
  background-color: var(--fc-today-bg-color, rgba(15, 172, 129, 0.07));
}
...
.fc .fc-list-event-dot {
  ...
  width: 0;
  height: 0;
  border: 5px solid #0fac81;
  border: calc(var(--fc-list-event-dot-width, 10px) / 2) solid var(--fc-event-border-color, #0fac81);
  border-radius: 5px;
...
.nk-header-app-logo .icon {
  ...
  font-size: 20px;
  color: #0fac81;
  background: rgba(15, 172, 129, 0.3);
}
.nk-header-app-info {
  line-height: 1.3;
}
...
.nk-sidebar {
  ...
  min-height: 100vh;
  max-height: 100vh;
  box-shadow: 1px 0px 6px 0px rgba(54, 74, 99, 0.08);
  z-index: 1021;
  left: 0;
  transform: translateX(-100%);
...
.nk-sidebar-bar.is-light {
  background: #fff;
  border-right-color: #ebeef2;
}
.nk-sidebar-bar.is-dark {
  background: #101924;
  border-right-color: #203247;
}
.nk-sidebar-bar.is-dark + .is-dark {
  background: #131e2b;
}
.nk-sidebar-bar.is-theme {
  background: #064936;
  border-right-color: #0a7859;
}
.nk-sidebar-bar.is-theme + .is-theme {
  background: #07523d;
}
.nk-sidebar-bar .dropdown-menu .lead-text {
  color: #364a63;
}
.nk-sidebar-bar .dropdown-menu .sub-text, .nk-sidebar-bar .dropdown-menu .overline-title, .nk-sidebar-bar .dropdown-menu .overline-title-alt {
  color: #8094ae;
}
.nk-sidebar-main {
  flex-grow: 1;
...
.nk-sidebar-main.is-dark {
  background: #101924;
  border-right-color: #203247;
}
.nk-sidebar-main.is-theme {
  background: #064936;
  border-right-color: #0a7859;
}
.nk-sidebar-overlay {
...
.nk-sidebar-footer {
  margin-top: auto;
  padding: 0.75rem 0.1875rem 0.5rem;
}
.nk-sidebar-body {
  position: relative;
}
...
.nk-sidebar .nk-menu:not(.apps-menu) .nk-menu-heading {
  padding-left: 0;
  padding-right: 0;
}
.nk-sidebar .nk-menu:not(.apps-menu) .nk-menu-toggle:after {
  right: 0;
}
.nk-sidebar .nk-menu:not(.apps-menu) > li > a {
  padding-left: 0;
  padding-right: 0;
}
...
@media (max-width: 420px) {
  .nk-sidebar-main {
    max-width: calc(100vw - 81px - 20px);
  }
  .nk-sidebar-profile-dropdown {
    max-width: calc(100vw - 81px - 10px);
    min-width: calc(100vw - 81px - 10px);
  }
}
...
.nk-sidebar-short.nk-sidebar-mobile .nk-sidebar-logo {
  opacity: 1;
}
.nk-sidebar-short.nk-sidebar-mobile .nk-sidebar-menu-middle {
  margin-top: 0;
}
.nk-sidebar-short .nk-sidebar-logo {
  opacity: 0;
}
.nk-sidebar-short .nk-sidebar-logo-small {
  display: none;
}
.nk-sidebar-short .nk-sidebar-menu-middle {
  margin-top: auto;
}
.nk-sidebar-short .nk-sidebar-footer {
  padding: 1rem 0;
}
.nk-sidebar-short .nk-menu-trigger {
  display: none;
}
...
@media (min-width: 768px) {
  ...
  .nk-sidebar-short.nk-sidebar-mobile {
    width: 80px !important;
  }
  .nk-sidebar-short + .nk-wrap {
    padding-left: 81px;
  }
  .nk-sidebar-short .nk-sidebar-head {
    width: 80px;
    border-bottom: none;
  }
  .nk-sidebar-short .nk-sidebar-logo {
...
.nk-menu-link {
  padding: 0.375rem 40px 0.375rem 24px;
  color: #6e82a5;
  font-family: Nunito, sans-serif;
  font-weight: 700;
  font-size: 14px;
...
.nk-menu-sub .nk-menu-link {
  padding: 0.375rem 28px 0.375rem 28px;
  font-family: Nunito, sans-serif;
  font-weight: 400;
  font-size: 13px;
  letter-spacing: normal;
...
.no-icon .nk-menu-sub .nk-menu-link {
  padding: 0.375rem 28px 0.375rem 18.6666666667px;
}
...
.nk-menu-content.menu-active {
  display: block;
}
.nk-menu-content .title {
...
.apps-menu .nk-menu-icon .icon {
  font-size: 24px;
}
.apps-menu.nk-menu-md .nk-menu-item {
  padding: 0.125rem 1.125rem;
}
.apps-menu.nk-menu-md .nk-menu-link {
  padding: 0.625rem;
  text-align: center;
}
.apps-menu.nk-menu-md .nk-menu-icon {
  width: 100%;
}
.apps-menu.nk-menu-md .nk-menu-icon .icon {
  font-size: 18px;
}
.apps-menu .active > .nk-menu-link {
  background-color: #fff;
}
.is-light .apps-menu .active > .nk-menu-link {
  background-color: #e2f5f0;
}
.is-dark .apps-menu .active > .nk-menu-link {
  background-color: #0b1219;
}
.is-theme .apps-menu .active > .nk-menu-link {
  background-color: #03231a;
}
...
.nk-sidebar-mobile .nk-sidebar-footer .short-menu {
  display: flex;
  align-items: center;
  flex-wrap: wrap;
  padding: 0 1rem;
}
.short-menu .nk-menu-item {
  padding: 0.125rem 0.875rem;
}
.nk-sidebar-mobile .nk-sidebar-footer .short-menu .nk-menu-item {
  width: 50%;
}
.nk-sidebar-footer .short-menu .nk-menu-item {
  padding: 0.125rem 0;
}
.short-menu .nk-menu-item.active .nk-menu-link {
  background-color: #fff;
}
.is-light .short-menu .nk-menu-item.active .nk-menu-link {
  background-color: #e2f5f0;
}
.is-dark .short-menu .nk-menu-item.active .nk-menu-link {
  background-color: #0b1219;
}
.is-theme .short-menu .nk-menu-item.active .nk-menu-link {
  background-color: #03231a;
}
.short-menu .nk-menu-link {
  border-radius: 4px;
  padding: 0.625rem;
}
.short-menu .nk-menu-link:hover, .short-menu .nk-menu-link.active {
  background-color: #fff;
}
.is-light .short-menu .nk-menu-link:hover, .is-light .short-menu .nk-menu-link.active {
  background-color: #e2f5f0;
}
.is-dark .short-menu .nk-menu-link:hover, .is-dark .short-menu .nk-menu-link.active {
  background-color: #0b1219;
}
.is-theme .short-menu .nk-menu-link:hover, .is-theme .short-menu .nk-menu-link.active {
  background-color: #03231a;
}
...
.nk-sidebar-footer .short-menu .nk-menu-icon .icon {
  font-size: 1.125rem;
}
.short-menu .nk-menu-text {
  opacity: 0;
}
.nk-sidebar-mobile .short-menu .nk-menu-text {
  opacity: 1;
}
.short-menu .nk-menu-tooltip {
  display: none;
}

@media (min-width: 768px) {
  .nk-sidebar-footer .short-menu {
    padding: 0;
  }
  .short-menu .nk-menu-item {
    padding: 0.125rem 1.125rem;
...
.accordion-s2 .accordion-item, .accordion-s3 .accordion-item {
  border: 0 !important;
}
...
.nk-error-head {
  font-size: 160px;
  font-weight: 700;
  background: -webkit-linear-gradient(#0fac81, #07523d);
...
.nk-tb-list .tb-asterisk a, .nk-tb-list .tb-asterisk .asterisk-on, .nk-tb-list .tb-asterisk a:hover, .nk-tb-list .tb-asterisk a.active {
  color: #0fac81;
}
.nk-tb-item {
...
.invoice-desc table td:first-child {
  min-width: 90px;
  display: inline-block;
  text-transform: uppercase;
  letter-spacing: 1px;
...
.nk-msg-aside {
  ...
  width: 100%;
  overflow: hidden;
  max-height: calc(100vh - (65px + 96px));
  position: relative;
  display: flex;
  flex-direction: column;
  flex-shrink: 0;
...
@media (min-width: 576px) {
  ...
  .nk-msg-aside {
    max-height: calc(100vh - (65px + 108px));
  }
}
@media (min-width: 576px) and (max-width: 991.98px) {
  .nk-msg-text .title {
...
@media (min-width: 768px) {
  .nk-msg-aside {
    max-height: calc(100vh - (65px + 112px));
  }
}
@media (min-width: 992px) {
  .nk-msg-nav {
...
.code-block + .code-block, .card-preview + .code-block {
  margin-top: 28px;
}
...
.nk-body.ui-softy, .nk-body.ui-shady, .nk-body.ui-softy .nk-header-fixed, .nk-body.ui-shady .nk-header-fixed {
...
.ui-softy .tb-tnx-head, .ui-shady .tb-tnx-head {
  background: rgba(245, 246, 250, 0.5);
}
...
.ui-softy .nk-ibx-aside, .ui-softy .nk-ibx-body,
.ui-softy .nk-fmg-aside, .ui-softy .nk-fmg-body,
.ui-softy .nk-msg-aside, .ui-softy .nk-msg-body,
.ui-softy .nk-chat-aside, .ui-softy .nk-chat-body {
  box-shadow: 0 1px 4px rgba(31, 43, 58, 0.15);
}

.ui-shady .nk-ibx-aside, .ui-shady .nk-ibx-body,
.ui-shady .nk-fmg-aside, .ui-shady .nk-fmg-body,
.ui-shady .nk-msg-aside, .ui-shady .nk-msg-body,
.ui-shady .nk-chat-aside, .ui-shady .nk-chat-body {
  box-shadow: 0 0 25px -12px rgba(31, 43, 58, 0.15);
}
...
.ui-rounder .card, .ui-rounder .ratio, .ui-rounder .accordion, .ui-rounder .invoice, .ui-rounder .code-block, .ui-rounder .swal2-popup, .ui-rounder .prettyprint,
.ui-rounder .invoice-wrap,
.ui-rounder .nk-ibx, .ui-rounder .nk-ibx-body,
.ui-rounder .nk-fmg-body,
.ui-rounder .nk-msg-aside, .ui-rounder .nk-msg-body,
.ui-rounder .nk-chat-aside, .ui-rounder .note-editor.note-frame, .ui-rounder .tox-tinymce {
  border-radius: 12px;
}
.ui-rounder .card > .list-group:first-child,
.ui-rounder .card-header:first-child,
.ui-rounder .card-img,
.ui-rounder .card-img-top, .ui-rounder .ql-toolbar, .ui-rounder .note-toolbar {
  border-top-left-radius: 11px;
  border-top-right-radius: 11px;
}
.ui-rounder .card > .list-group:last-child, .ui-rounder .card-footer:last-child, .ui-rounder .ql-container {
...
.dark-mode .bg-primary-dim, .dark-mode .dual-listbox .dual-listbox__item:active, .dual-listbox .dark-mode .dual-listbox__item:active, .dark-mode .dual-listbox .dual-listbox__item.dual-listbox__item--selected, .dual-listbox .dark-mode .dual-listbox__item.dual-listbox__item--selected {
  background-color: #17363a !important;
}
...
.dark-mode .bs-popover-top > .popover-arrow::before, .dark-mode .bs-popover-auto[data-popper-placement^=top] > .popover-arrow::before {
  border-top-color: #23364e !important;
}
...
.dark-mode .bs-popover-bottom > .popover-arrow::before, .dark-mode .bs-popover-auto[data-popper-placement^=bottom] > .popover-arrow::before {
  border-bottom-color: #23364e !important;
}
...
.dark-mode .bs-popover-end > .popover-arrow::before, .dark-mode .bs-popover-auto[data-popper-placement^=right] > .popover-arrow::before {
  border-right-color: #23364e !important;
}
...
.dark-mode .bs-popover-start > .popover-arrow::before, .dark-mode .bs-popover-auto[data-popper-placement^=left] > .popover-arrow::before {
  border-left-color: #23364e !important;
}
...
.dark-mode .nk-header-fixed {
  background: #101924;
}
.dark-mode .nk-sidebar-bar.is-theme, .dark-mode .nk-sidebar-bar, .dark-mode .nk-menu-hr, .dark-mode .nk-sidebar-main, .dark-mode .nk-header-fixed {
  border-color: #203247;
}
.dark-mode .nk-sidebar-bar.is-theme, .dark-mode .nk-sidebar-bar {
  background: #101924;
}
.dark-mode .nk-sidebar-bar.is-dark + .is-dark, .dark-mode .nk-sidebar-main.is-theme, .dark-mode .nk-sidebar-main {
  background: #121b28;
}
.dark-mode .apps-menu .active > .nk-menu-link {
  background-color: #0b1219;
}
...
.dark-mode .nk-msg-nav .search-wrap, .dark-mode .nk-msg-body, .dark-mode .nk-fmg-body, .dark-mode .nk-chat-body, .dark-mode .nk-ibx-body,
...
.dark-mode .data-list-s2 .data-head, .dark-mode .nk-header-search .form-control, .dark-mode .nk-header-search div.dataTables_wrapper div.dataTables_filter input, div.dataTables_wrapper div.dataTables_filter .dark-mode .nk-header-search input, .dark-mode .nk-header-search .dual-listbox .dual-listbox__search, .dual-listbox .dark-mode .nk-header-search .dual-listbox__search {
  background: transparent !important;
}
.dark-mode .chat-sap-meta:before, .dark-mode .chat-sap-meta:after, .dark-mode .nk-profile-content,
...
.dark-mode .nk-chat-aside, .dark-mode .nk-chat-profile, .dark-mode .nk-chat-head, .dark-mode .chat-msg, .dark-mode .nk-chat-editor, .dark-mode .nk-chat-blank, .dark-mode .nk-chat-editor .form-control, .dark-mode .nk-chat-editor div.dataTables_wrapper div.dataTables_filter input, div.dataTables_wrapper div.dataTables_filter .dark-mode .nk-chat-editor input, .dark-mode .nk-chat-editor .dual-listbox .dual-listbox__search, .dual-listbox .dark-mode .nk-chat-editor .dual-listbox__search,
.dark-mode .nk-fmg-aside, .dark-mode .nk-fmg-body, .dark-mode .nk-fmg-body .form-control, .dark-mode .nk-fmg-body div.dataTables_wrapper div.dataTables_filter input, div.dataTables_wrapper div.dataTables_filter .dark-mode .nk-fmg-body input, .dark-mode .nk-fmg-body .dual-listbox .dual-listbox__search, .dual-listbox .dark-mode .nk-fmg-body .dual-listbox__search, .dark-mode .nk-fmg-body-head,
.dark-mode .nk-files-view-grid .nk-file, .dark-mode .nk-files-view-group .nk-file,
.dark-mode .nk-ibx-aside, .dark-mode .nk-ibx-item, .dark-mode .nk-ibx-view,
.dark-mode .nk-msg-head, .dark-mode .nk-msg-profile, .dark-mode .nk-fmg-switch {
  background: #18212d;
}
...
.dark-mode .fc .fc-toolbar.fc-header-toolbar .fc-toolbar-chunk .btn:focus, .dark-mode .fc .fc-toolbar.fc-header-toolbar .fc-toolbar-chunk .dual-listbox .dual-listbox__button:focus, .dual-listbox .dark-mode .fc .fc-toolbar.fc-header-toolbar .fc-toolbar-chunk .dual-listbox__button:focus {
  box-shadow: 0 0 0 0.2rem rgba(35, 54, 78, 0.5);
}
.dark-mode .fc .fc-toolbar.fc-header-toolbar .fc-toolbar-chunk .btn.active, .dark-mode .fc .fc-toolbar.fc-header-toolbar .fc-toolbar-chunk .dual-listbox .active.dual-listbox__button, .dual-listbox .dark-mode .fc .fc-toolbar.fc-header-toolbar .fc-toolbar-chunk .active.dual-listbox__button {
  ...
  border-color: #23364e !important;
  background: #101924;
  box-shadow: inset 0 0 4px -1px rgba(35, 54, 78, 0.25);
}
.dark-mode .fc-day {
  color: #b6c6e3;
}
...
.dark-mode a.fc-event-primary-dim {
  background-color: #17363a !important;
  border-color: #17363a !important;
}
.dark-mode .modal-header.fc-event-primary-dim {
  background-color: #17363a !important;
  border-color: #102528 !important;
}
